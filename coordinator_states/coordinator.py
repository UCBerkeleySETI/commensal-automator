...
class Coordinator(object):
    ...
    def start(self):
        ...
        for array in self.arrays:
            ...
            # TODO: Detect current state for array and select initial states.
            # For now, assume we will start in READY and FREE
            ...
            self.recproc_machines[array] = RecProcMachine(Ready(array, self.r), self.free.copy(), self.subscribed[array])
